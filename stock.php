...
$com=$_POST['company'];
$sup=$_POST['supplier'];
$qua=$_POST['stock_quantity'];
$cost=$_POST['cost'];
$sta="Available";

$sql=mysqli_query($con,"INSERT INTO stock(drug_name,category,description,company,supplier,stock_quantity,cost,status,date_supplied)
    ...
    <div class="tabbed_area">  
		...
		*/
        ...
        echo "<table border='1' cellpadding='3'>";
         echo "<tr><th>ID</th><th>Name</th><th>Category</th><th>Description</th><th>Status</th><th>Quantity </th><th>Date </th><th>Delete</th></tr>";
        ...
        <div id="content_2" class="content">  
		 ...
		 <?php echo $message;
			...
			<table width="420" height="106" border="0" >	
				...
				<tr><td align="center"><input name="stock_quantity" type="text" style="width:170px" placeholder="Quantity" required="required" id="quantity" /></td></tr>  
...
<div id="footer" align="Center">THE PHARMACY MANGEMENT SYSTEM</div>
</div>
</body>
</html>
