...
<hr/>	
    <div class="tabbed_area">  
       ...
       $result = mysqli_query($con,"SELECT * FROM pharmacist")or die(mysql_error());
        ...
        echo "<tr> <th>ID</th><th>Firstname </th> <th>Lastname </th> <th>Username </th> <th>Email </th><th>Update </th><th>Delete</th></tr>";
...
?> 
		...
		<form name="form1" onsubmit="return validateForm(this);" action="admin_pharmacist.php" method="post" >
			<table width="300" height="300" border="0" >	
				...
				<tr><td align="center"><input name="postal_address" type="text" style="width:200px" placeholder="Address" required="required" id="postal_address" /></td></tr>  
