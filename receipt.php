...
$details1=mysqli_fetch_array($getName,MYSQLI_BOTH); 
$details=mysqli_fetch_array($getCid,MYSQLI_NUM);
...
$titling= <<<EOD
<strong> <font style="font-size:11">THE PHARMACY</font> </strong> <br> <strong>Official Receipt</strong><br>
NBNSSOE<br>Ambegaon(bk), PUNE <br> Tel:+91 7030145091 <br> E-mail: krajat02@gmail.com 
<br>-----------------------------------------
EOD;
