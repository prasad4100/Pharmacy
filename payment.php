...
<div id="button">
		<ul>
			<li><a href="cashier.php"><SPAN>DASHBOARD</SPAN></a></li>
			<li><a href="payment.php"target="_top"><SPAN>PROCESS<BR>PAYMENTS</SPAN></a></li>
...
type: "POST", url: "check.php", data: 'invoice_no='+invoice_no , success: function(msg)
		...
		<div id="viewer1"><span id="viewer2"></span></div>
		 ...
		 while($pType=mysqli_fetch_array($getpayType,MYSQLI_BOTH))
			{
